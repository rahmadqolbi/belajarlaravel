        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-md-3 mb-3">
                 <input type="text" name="search" class="form-control" id="search" placeholder="Cari Data..." value="{{ request('search') }}">
                </form>
                </div>
                ...
                <table class="table table-bordered table-hover width="100%" cellspacing="0"">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $list->telepon }}</td>
                            <td>
    <span class="badge {{ $list->status === 'Aktif' ? 'badge-success' : 'badge-danger' }} small">
        {{ ucfirst($list->status) }}
    </span>
</td>
                    ...
                    <a href="{{ route('gudang.add') }}" class="btn btn-primary">Tambah</a>

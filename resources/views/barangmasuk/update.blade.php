 ...
 <form action="{{ route('barangmasuk.update', $data->id) }}" method="POST">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="date" class="form-control text-uppercase @error('tanggal') is-invalid @enderror" name="tanggal" value="{{ old('tanggal', $data->tanggal->format('Y-m-d')) }}">
              @error('tanggal')
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control text-uppercase @error('no_dokumen') is-invalid @enderror" name="no_dokumen" value="{{ $data->no_dokumen }}" readonly>
              @error('no_dokumen')
                        {{-- <div class="alert alert-danger w-50">{{ $message }}</div> --}}
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control text-uppercase @error('keterangan') is-invalid @enderror" name="keterangan" value="{{ $data->keterangan }}">
               @error('keterangan')
                        {{-- <div class="alert alert-danger w-50">{{ $message }}</div> --}}
                        <div class="text-danger mt-1">{{ $message }}</div>
                    @enderror

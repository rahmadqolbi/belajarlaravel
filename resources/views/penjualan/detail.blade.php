...
@section('content')
<form action="{{ route('penjualan.detail', $penjualan->id) }}" method="POST">
    @csrf
    @method('PUT')
...
<div class="container-fluid">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Form Detail Penjualan</h5>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="metode_pembayaran" disabled>
...
@elseif(isset($detailPenjualan) && $detailPenjualan->count() > 0)
    ...
    @foreach($detailPenjualan as $detail)
        <tr>
            <td>
                <select name="produk_id[]" class="form-control product-select" disabled>
                    <option value="">-- Pilih Produk --</option>
                    @foreach ($produk as $pro)
                        <option value="{{ $pro->id }}"
                            data-harga="{{ $pro->harga }}"
            ...
            <td>
                <input type="number" name="qty[]" class="form-control text-end qty" value="{{ $detail->qty }}" disabled>
            </td>
            <td>
